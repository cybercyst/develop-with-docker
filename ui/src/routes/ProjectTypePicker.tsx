...
export function ProjectTypePicker() {
  ...
  const options = [
    {
      ...
      description:
        "Create a full-stack application. This will generate both a backend server and a frontend application.",
      id: "full-stack",
    },
    {
    ...
    },
    {
      ...
      description:
        "Create a frontend application. This will generate a web application in the framework of your choice.",
      id: "frontend-app",
    },
  ];
  ...
  return (
    <>
      ...
      <Typography sx={{ mt: 8 }} variant="subtitle2">
        ...
        {options.map((option) => {
          return (
            <Card sx={{ height: 300, width: 250 }} key={option.id}>
              <CardActionArea onClick={() => navigate(`/backend-picker`)}>
                <CardMedia
                  component="img"
                  height="140"
                  image={option.image}
